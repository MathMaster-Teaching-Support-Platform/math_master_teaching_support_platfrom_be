 ...
 *
 * <p>Binds to properties with prefix {@code app.init} from application.yml/properties.
 * Supports loading passwords from environment variables for security.
 *
...
public class InitProperties {
  ...
  /**
   * Whether to enable application initialization.
   * Default: true
   */
   ...
   */
  @Valid
  private UserConfig student;

  /**
   * Teacher user configuration.
   */
  @Valid
  private UserConfig teacher;
