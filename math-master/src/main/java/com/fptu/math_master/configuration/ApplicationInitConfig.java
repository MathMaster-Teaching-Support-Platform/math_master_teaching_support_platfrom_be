 ...
 *
 * <p>This is a thin configuration layer that delegates actual initialization logic to {@link
 * ApplicationInitLogic}. Can be disabled via {@code app.init.enabled=false} property.
 *
...
public class ApplicationInitConfig {
  ...
  private static final String LOG_INIT_SUCCESS =
   ...
   *
   * <p>Only runs when {@code app.init.enabled=true} (default). Works with any database (PostgreSQL,
   * MySQL, H2, etc.)
   *
