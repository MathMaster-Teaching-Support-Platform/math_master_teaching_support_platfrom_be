...
public class QuestionBankController {
  ...
  @Operation(
    ...
    description = "Teacher creates a question bank to organize questions by topic. " +
  ...
  @Operation(
    ...
    description = "Teacher can edit question bank information. Only owner or admin can edit. " +
  ...
  @Operation(
    ...
    description = "Teacher can delete question bank. Soft delete is performed (set deleted_at). " +
  ...
  public ApiResponse<Void> deleteQuestionBank(@PathVariable UUID id) {
    ...
    return ApiResponse.<Void>builder()
      .message("Question bank deleted successfully. Questions have been unlinked but not deleted.")
      .build();
  }
  ...
  @Operation(
    ...
    description = "Get question bank details. Accessible by owner, public banks can be viewed by others."
  )
  ...
  @Operation(
    ...
    description = "Teacher views all their question banks in grid/list view. " +
  ...
  @Operation(
    ...
    description = "Search question banks with filters: subject, grade level, public/private status, and search term. " +
  ...
  public ApiResponse<Page<QuestionBankResponse>> searchQuestionBanks(
    ...
    log.info("REST request to search question banks - subject: {}, gradeLevel: {}, isPublic: {}, searchTerm: {}",
    ...
    return ApiResponse.<Page<QuestionBankResponse>>builder()
      .result(questionBankService.searchQuestionBanks(subject, gradeLevel, isPublic, searchTerm, pageable))
      .build();
  }
  ...
  @Operation(
    ...
    description = "Teacher can share question bank by toggling 'Make Public' switch. " +
  ...
  @Operation(
    ...
    description = "Verify if current user has permission to edit the question bank (owner or admin)."
  )
  ...
  @Operation(
    ...
    description = "Verify if current user has permission to delete the question bank (owner or admin)."
  )
