...
public class PermissionController {
  ...
  @Operation(
      ...
      description =
          "Update an existing permission's information by permission ID. Only accessible by ADMIN role.")
  public ApiResponse<PermissionResponse> updatePermission(
      @PathVariable UUID permissionId, @Valid @RequestBody PermissionUpdateRequest request) {
