...
public class AuthenticationController {
    ...
    @Operation(
            summary = "User login",
            description = "Authenticate user credentials and return access token (JWT) along with related authentication information."
    )
    ...
    @Operation(
            ...
            description = "Validate an access token and return its status, expiration time, and associated user information."
    )
    ...
    @Operation(
            ...
            description = "Generate a new access token using a valid refresh token when the current access token is expired."
    )
    ...
    @Operation(
            summary = "User logout",
            description = "Invalidate the refresh token or access token to terminate the current user session."
    )
