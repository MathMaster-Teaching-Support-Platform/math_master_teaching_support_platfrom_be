...
public class OllamaController {
  ...
  public ApiResponse<String> testConnection() {
    ...
    if (isConnected) {
      return ApiResponse.<String>builder().result("Ollama connection successful!").build();
    } else {
  ...
  public ApiResponse<OllamaChatResponse> sendMessage(@RequestBody MessageRequest request) {
    ...
    try {
      ...
      return ApiResponse.<OllamaChatResponse>builder().result(response).build();
  ...
  public ApiResponse<OllamaChatResponse> chatWithHistory(@RequestBody ConversationRequest request) {
