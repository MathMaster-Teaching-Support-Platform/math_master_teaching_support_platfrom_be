...
public class StudentAssessmentController {
    ...
    @Operation(
        ...
        description = "Get list of available assessments for the current student. " +
    ...
    @Operation(
        ...
        description = "Update answer for a question. " +
    ...
    @Operation(
        summary = "Update flag",
        description = "Flag/unflag a question for review. " +
                     "Saves flag state to Redis and publishes ACK."
    )
    @PostMapping("/flag")
    @PreAuthorize("hasRole('STUDENT')")
    public ApiResponse<AnswerAckResponse> updateFlag(
    ...
    @Operation(
        ...
        description = "Submit the assessment attempt. " +
    ...
    @Operation(
        ...
        description = "Get current draft state from Redis for reconnection/resume. " +
                     "Returns answers, flags, time remaining, and progress."
    )
    @GetMapping("/attempts/{attemptId}/snapshot")
    @PreAuthorize("hasRole('STUDENT')")
    public ApiResponse<DraftSnapshotResponse> getDraftSnapshot(
    ...
    @Operation(
        ...
        description = "Save current progress and exit. " +
                     "Attempt remains IN_PROGRESS for later resume."
    )
