...
public class QuestionTemplateController {
  ...
  @Operation(
    ...
    description = "Teacher creates a question template with dynamic parameters. " +
  ...
  @Operation(
    ...
    description = "Teacher tests template before saving. System generates sample questions " +
  ...
  @Operation(
    ...
    description = "Generate test samples for an existing template. " +
  ...
  @Operation(
    ...
    description = "Get question template details. Accessible by owner, public templates can be viewed by others."
  )
  ...
  @Operation(
    ...
    description = "Teacher views all their question templates. Shows name, type, " +
  ...
  @Operation(
    ...
    description = "Search templates by type, cognitive level, public status, tags, or search term. " +
  ...
  public ApiResponse<Page<QuestionTemplateResponse>> searchQuestionTemplates(
    ...
    return ApiResponse.<Page<QuestionTemplateResponse>>builder()
      .result(questionTemplateService.searchQuestionTemplates(
  ...
  @Operation(
    ...
    description = "Generate test samples with optional AI enhancement. " +
  ...
  @Operation(
    ...
    description = "Generate a single AI-enhanced question from template. " +
  ...
  public ApiResponse<AIEnhancedQuestionResponse> generateAIEnhancedQuestion(@PathVariable UUID id) {
    ...
    if (response.isEnhanced() && response.isValid()) {
      ...
      message = "AI enhancement validation failed. Fallback to original question. Errors: " +
...
//  @PreAuthorize("hasAnyRole('TEACHER', 'ADMIN')")
  @Operation(
    ...
    description = "Teacher uploads Word/PDF/Text file and system analyzes it with AI to suggest a question template. " +
                  "Steps: " +
  ...
  public ApiResponse<TemplateImportResponse> importTemplateFromFile(
    ...
    TemplateImportResponse response = templateImportService.importTemplateFromFile(
        file, subjectHint, contextHint
    );

    String message;
    if (response.getAnalysisSuccessful()) {
      message = "Template analysis completed. Please review and edit the suggested template before saving.";
    } else {
      message = "Template import completed with warnings. Please review carefully: " +
