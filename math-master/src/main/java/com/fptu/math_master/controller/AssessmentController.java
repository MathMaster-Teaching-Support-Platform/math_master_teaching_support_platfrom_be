...
public class AssessmentController {
  ...
  @Operation(
    ...
    description = "Teacher creates a new assessment (quiz/test/exam/homework). " +
  ...
  public ApiResponse<AssessmentResponse> createAssessment(@Valid @RequestBody AssessmentRequest request) {
  ...
  @Operation(
    ...
    description = "Update assessment details. Only DRAFT assessments can be edited. " +
  ...
  @Operation(
    ...
    description = "Teacher can override default points for a question in this specific assessment. " +
  ...
  public ApiResponse<AssessmentResponse> setPointsOverride(
    ...
    @Valid @RequestBody PointsOverrideRequest request) {
    log.info("REST request to set points override for assessment: {}, question: {}",
      assessmentId, request.getQuestionId());
    return ApiResponse.<AssessmentResponse>builder()
  ...
  @Operation(
    ...
    description = "Teacher can preview how the assessment will look to students. " +
  ...
  @Operation(
    ...
    description = "Get assessment summary before publishing with validation checks: " +
  ...
  @Operation(
    ...
    description = "Unpublish assessment to edit it. " +
  ...
  @Operation(
    ...
    description = "Delete assessment. Can only delete if Status = DRAFT and no submissions exist. " +
  ...
  @Operation(
    ...
    description = "Get assessment details. Teachers/admins can view all, students can view published assessments."
  )
  ...
  @Operation(
    ...
    description = "Get all assessments created by current teacher. " +
  ...
  @Operation(
    ...
    description = "Verify if current user can edit the assessment (owner/admin and status = DRAFT)."
  )
  public ApiResponse<Boolean> canEditAssessment(@PathVariable UUID id) {
    ...
    return ApiResponse.<Boolean>builder()
      .result(assessmentService.canEditAssessment(id))
      .build();
  }
  ...
  @Operation(
    ...
    description = "Verify if current user can delete the assessment (owner/admin, DRAFT, no submissions)."
  )
  public ApiResponse<Boolean> canDeleteAssessment(@PathVariable UUID id) {
    ...
    return ApiResponse.<Boolean>builder()
      .result(assessmentService.canDeleteAssessment(id))
      .build();
  }
  ...
  @Operation(
    ...
    description = "Verify if current user can publish the assessment (owner/admin, DRAFT, has questions)."
  )
