...
public class UserController {
  ...
  @Operation(
    ...
    description = "Create a new user account with the provided information. Only accessible by ADMIN role."
  )
  ...
  @Operation(
    ...
    description = "Search and filter users based on various criteria with pagination. Only accessible by ADMIN role."
  )
  ...
  public ApiResponse<UserResponse> banUser(
    ...
    return ApiResponse.<UserResponse>builder()
      .result(userService.banUser(userId, reason))
      .build();
  }
