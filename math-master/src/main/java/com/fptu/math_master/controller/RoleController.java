...
public class RoleController {
  ...
  @Operation(
      ...
      description =
          "Update an existing role's information by role ID. Only accessible by ADMIN role.")
  ...
  @PreAuthorize("hasRole('ADMIN')")
  @Operation(summary = "Get role by name", description = "Retrieve role information by role name.")
  public ApiResponse<RoleResponse> getRoleByName(@PathVariable String name) {
    log.info("REST request to get role by name: {}", name);
    return ApiResponse.<RoleResponse>builder().result(roleService.getRoleByName(name)).build();
  }
  ...
  @Operation(
      ...
      description =
          "Add one or more permissions to an existing role. Only accessible by ADMIN role.")
  public ApiResponse<RoleResponse> addPermissionsToRole(
      @PathVariable UUID roleId, @RequestBody List<String> permissionCodes) {
  ...
  @Operation(
      ...
      description =
          "Remove one or more permissions from an existing role. Only accessible by ADMIN role.")
