...
public class ExamMatrixController {
  ...
  @Operation(
    ...
    description = "Teacher creates exam matrix for assessment. " +
  ...
  @Operation(
    ...
    description = "Teacher selects chapters and cognitive levels (Bloom's Taxonomy). " +
  ...
  public ApiResponse<ExamMatrixResponse> configureMatrixDimensions(
    ...
    @Valid @RequestBody MatrixDimensionRequest request) {
    log.info("REST request to configure matrix dimensions for: {}", matrixId);
    return ApiResponse.<ExamMatrixResponse>builder()
      .message(String.format("Matrix configured: %d chapters × %d cognitive levels = %d cells",
  ...
  @Operation(
    ...
    description = "Teacher fills each cell with: " +
                  "- Number of questions " +
                  "- Points per question " +
  ...
  public ApiResponse<MatrixCellResponse> createOrUpdateMatrixCell(
    @PathVariable UUID matrixId,
    @Valid @RequestBody MatrixCellRequest request) {
  ...
  @Operation(
    ...
    description = "System automatically suggests matching questions based on: " +
  ...
  @Operation(
    ...
    description = "Teacher manually selects questions for a cell instead of using auto-suggest. " +
  ...
  public ApiResponse<MatrixCellResponse> selectQuestionsManually(
    ...
    log.info("REST request to manually select {} questions for cell: {}",
      request.getQuestionIds().size(), request.getMatrixCellId());
    return ApiResponse.<MatrixCellResponse>builder()
      .message(String.format("%d questions selected successfully", request.getQuestionIds().size()))
  ...
  @Operation(
    ...
    description = "Teacher approves matrix after validation. " +
  ...
  public ApiResponse<ExamMatrixResponse> getExamMatrixByAssessmentId(@PathVariable UUID assessmentId) {
  ...
  public ApiResponse<Void> deleteExamMatrix(@PathVariable UUID matrixId) {
    ...
    return ApiResponse.<Void>builder()
      .message("Exam matrix deleted successfully.")
      .build();
  }
  ...
  @Operation(
    ...
    description = "System automatically locks matrix when assessment is published. " +
  ...
  public ApiResponse<Void> lockMatrix(@PathVariable UUID matrixId) {
    ...
    return ApiResponse.<Void>builder()
      .message("Matrix locked successfully.")
      .build();
  }
}
