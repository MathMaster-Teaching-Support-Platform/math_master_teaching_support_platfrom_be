 ...
 *
 * <p>Handles the creation of default permissions, roles, and users
...
public interface ApplicationInitLogic {
   ...
   * <p>Creates:
   * <ul>
   *   <li>Default permissions (user, role, permission, quiz management)</li>
   *   <li>Default roles (ADMIN, TEACHER, STUDENT)</li>
   *   <li>Default users based on provided configuration</li>
   * </ul>
   *
