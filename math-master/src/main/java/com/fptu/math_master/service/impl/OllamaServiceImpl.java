...
public class OllamaServiceImpl implements OllamaService {
    ...
    public OllamaServiceImpl(@Qualifier("ollamaRestClient") RestClient ollamaRestClient,
                             OllamaProperties ollamaProperties) {
    ...
    public OllamaChatResponse chat(List<OllamaChatRequest.Message> messages) {
        ...
        try {
            ...
            log.info("Calling Ollama API at {} with model {}", ollamaProperties.getBaseUrl(), ollamaProperties.getModel());
    ...
    public boolean testConnection() {
        try {
            ...
            String response = ollamaRestClient.get()
                    .uri("/api/tags")
                    .exchange((req, resp) -> {
                        java.io.InputStream inputStream = resp.getBody();
                        return new String(inputStream.readAllBytes(), java.nio.charset.StandardCharsets.UTF_8);
